## This will deploy server microsoft with multiple service , define DomainName, NetbiosName, SafemodePassword
...
# Add WSUS feature and its console
Add-WindowsFeature UpdateServices, UpdateServices-Ui
